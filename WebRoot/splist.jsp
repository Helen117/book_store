...
<% 
	...
	if(vgoods==null)
	{
        ...
        String gsql = "select Bimgurl,Bname,Bintro,Bclass,"+
        			"Bprice,Blook,Bid from booksinfo";
        int totalpage = DBcart.getTotalPage("select count(*) from booksinfo");
    ...
    <td colspan="2">
      <table width="100%">
        ...
        <tr>
          <td>
          <% 
          	String temp = "select Bamount from booksinfo where Bamount<1 and Bid="+str[6];
